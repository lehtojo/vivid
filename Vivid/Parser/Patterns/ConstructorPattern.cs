...
public class ConstructorPattern : Pattern
{
	...
	public override bool Passes(Context context, PatternState state, List<Token> tokens)
	{
		...
		return type != null && (head.Name == Keywords.INIT.Identifier || head.Name == Keywords.DEINIT.Identifier);
	}
	...
	public override Node? Build(Context context, PatternState state, List<Token> tokens)
	{
		...
		{
			var constructor = new Constructor(context, AccessModifier.PUBLIC, body.Tokens, header.Position);
		...
		{
			var destructor = new Constructor(context, AccessModifier.PUBLIC, body.Tokens, header.Position);
